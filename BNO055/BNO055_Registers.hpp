...
/*< This refers BNO055 return type as I8 */
#define BNO055_RETURN_FUNCTION_TYPE         I8
...
#define BNO055_E_NULL_PTR                          ((I8) - 127)
#define BNO055_OUT_OF_RANGE                        ((I8) - 2)
#define BNO055_SUCCESS                             ((U8)0)
#define BNO055_ERROR                               ((I8) - 1)
...
{
    I16 w; /**< Quaternion w data */
    I16 x; /**< Quaternion x data */
    I16 y; /**< Quaternion y data */
    I16 z; /**< Quaternion z data */
};
...
{
    I16 x; /**< Linear Accel x data */
    I16 y; /**< Linear Accel y data */
    I16 z; /**< Linear Accel z data */
};
...
{
    I16 x; /**< Gravity x data */
    I16 y; /**< Gravity y data */
    I16 z; /**< Gravity z data */
};
...
{
    F64 x; /**< accel x float data */
    F64 y; /**< accel y float data */
    F64 z; /**< accel z float data */
};
...
{
    F64 x; /**< Mag x float data */
    F64 y; /**< Mag y float data */
    F64 z; /**< Mag z float data */
};
...
{
    F64 x; /**< Gyro x float data */
    F64 y; /**< Gyro y float data */
    F64 z; /**< Gyro z float data */
};
...
{
    F64 x; /**< Linear accel x float data */
    F64 y; /**< Linear accel y float data */
    F64 z; /**< Linear accel z float data */
};
...
{
    F64 x; /**< Gravity x float data */
    F64 y; /**< Gravity y float data */
    F64 z; /**< Gravity z float data */
};
#endif
...
{
    I16 x; /**< Accel offset x data */
    I16 y; /**< Accel offset y data */
    I16 z; /**< Accel offset z data */
    I16 r; /**< Accel radius r data */
};
...
{
    I16 x; /**< Gyro offset x data */
    I16 y; /**< Gyro offset y data */
    I16 z; /**< Gyro offset z data */
};
...
{
    I16 x; /**< Mag offset x data */
    I16 y; /**< Mag offset y data */
    I16 z; /**< Mag offset z data */
